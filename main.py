...
# graf
            vycistena_slova= [slovo.replace(" ", "").replace(",", "").replace(".", "") for slovo in text_slova]
        ...
        print("uvlalid choice, you should have selected a number between 1 and 3...terminating the program....")
        exit()
else:
    print("uvlalid choice, you should have selected a number between 1 and 3...terminating the program....")
    exit()

print("There are " + str(len(text_slova)) + " words in the selected text." )
print("There are " + str(pocet_velka_slova) + " titlecase words.")
